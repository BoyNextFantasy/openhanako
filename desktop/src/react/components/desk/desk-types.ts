...
export const ICONS = {
  ...
  sort: '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7.5 4v15M7.5 4L4.5 7M7.5 4l3 3"/><path d="M16.5 20V5M16.5 20l-3-3M16.5 20l3-3"/></svg>',
  filter: '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 4.5h17l-6.5 8v6l-4 2.5v-8.5z"/></svg>',
} as const;

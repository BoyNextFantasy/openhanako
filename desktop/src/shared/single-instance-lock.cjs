 ...
 *
 * Electron's requestSingleInstanceLock() is scoped by userData, so Satori sets
 * userData from SATORI_HOME before requesting the lock. Production and dev homes
